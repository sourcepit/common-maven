...
public class EnvironmentAdapterFactory extends AdapterFactoryImpl
{
   ...
   {
      @Override
      public Adapter caseEnvironmentSnapshot(EnvironmentSnapshot object)
      {
         return createEnvironmentSnapshotAdapter();
      }
   ...
   /**
    * Creates a new adapter for an object of class '{@link org.sourcepit.common.maven.environment.EnvironmentSnapshot
    * <em>Snapshot</em>}'.
    * <!-- begin-user-doc -->
    ...
    * @generated
    */
   public Adapter createEnvironmentSnapshotAdapter()
   {
      return null;
   }
